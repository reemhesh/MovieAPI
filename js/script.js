            ...
            for(var i =0 ; i<upcomingMovies.length; i++)
            {
              ...
              `
                    ...
                    <div class="movie-poster">
                        <a href="movie-details.html"><img class ="rounded-5" src="https://image.tmdb.org/t/p/w500${upcomingMovies[i].poster_path}" alt=""></a>
                    </div>
  ...
  .then(data => 
        {
            ...
            for(var i =0 ; i<latestTV.length; i++)
            {
              ...
              `
                    <div class="movie-item mb-50" >
                    <div class="movie-poster">
                        <a href="movie-details.html"><img  class ="rounded-5"src="https://image.tmdb.org/t/p/w500${latestTV[i].poster_path}" alt=""></a>
                    </div>
                    <div class="movie-content">
                        <div class="top">
            ...
            for(var i =0 ; i<trendingMovies.length; i++)
            {
              ...
              `
                      ...
                      <div class="movie-item mb-60">
                          <div class="movie-poster">
                              <a href="movie-details.html"><img class ="rounded-5" src="https://image.tmdb.org/t/p/w500${trendingMovies[i].poster_path}"  alt=""></a>
  ...
  .then(data => 
        {
            ...
            for(var i =0 ; i<trendingTv.length; i++)
            {
              ...
              `
                      ...
                      <div class="movie-item mb-60">
                          <div class="movie-poster">
                              <a href="movie-details.html"><img class ="rounded-5"  src="https://image.tmdb.org/t/p/w500${trendingTv[i].poster_path}"  alt=""></a>
  ...
  .then(data => 
        {
            ...
            for(var i =0 ; i<trendingPersons.length; i++)
            {
              ...
              `
                      ...
                      <div class="movie-item mb-60">
                          <div class="movie-poster">
                              <a href="movie-details.html"><img  class ="rounded-5" src="https://image.tmdb.org/t/p/w500${trendingPersons[i].profile_path}"  alt=""></a>
                              
                          </div>
                          <div class="movie-content">
                              <div class="top">
                                  <h5 class="title"><a href="#">
                                  ${trendingPersons[i].name}
                                  </a></h5>
                                  <span class="date">${trendingPersons[i].known_for_department}</span>
                              </div>
                              <div class="bottom">
                                  <ul>
                                      <li><span class="quality">hd</span></li>
                                      <li>
                                          ...
                                          <span class="rating"><i class="fas fa-thumbs-up"></i> ${trendingPersons[i].popularity }</span>
                                      </li>
                                  </ul>
                              </div>
                          </div>
